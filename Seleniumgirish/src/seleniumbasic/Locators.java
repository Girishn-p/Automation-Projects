...
driver.findElement(By.id("inputUsername")).sendKeys("girish");
...
driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("girish@rsa.com");
...
driver.findElement(By.cssSelector("#inputUsername")).sendKeys("girish");
